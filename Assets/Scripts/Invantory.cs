...
public class Invantory : MonoBehaviour
{
    ...
    void GetPlayerTransform()
    {
        ...
        {
            Debug.Log("Player not found! Transform could not be specified.");
        }
    }
    ...
    public void UseSelectedItem()
    {
        ...
        objectsInInvantory[currentlySelectedItem].itemLogic.UseItem(playerTransform, objectsInInvantory[currentlySelectedItem]);
    ...
    public void UseItemAtID(int id)
    {
        ...
        objectsInInvantory[id].itemLogic.UseItem(playerTransform, objectsInInvantory[id]);
